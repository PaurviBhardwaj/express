...
describe('res', function() {
  describe('.sendFile(path)', function() {
    ...
    it('should transfer a file', function(done) {
      let app = createApp(path.resolve(fixtures, 'name.txt'));
    ...
    it('should transfer a file with special characters in string', function(done) {
      let app = createApp(path.resolve(fixtures, '% of dogs.txt'));
    ...
    it('should 404 for directory', function(done) {
      let app = createApp(path.resolve(fixtures, 'blog'));
    ...
    it('should 404 when not found', function(done) {
      let app = createApp(path.resolve(fixtures, 'does-no-exist'));
    ...
    describe('with "cacheControl" option', function() {
      it('should enable cacheControl by default', function(done) {
        let app = createApp(path.resolve(__dirname, 'fixtures/name.txt'));
      ...
      it('should accept cacheControl option', function(done) {
        let app = createApp(path.resolve(__dirname, 'fixtures/name.txt'), {cacheControl: false});
    ...
    describe('with "dotfiles" option', function() {
      it('should not serve dotfiles by default', function(done) {
        let app = createApp(path.resolve(__dirname, 'fixtures/.name'));
      ...
      it('should accept dotfiles option', function(done) {
        let app = createApp(path.resolve(__dirname, 'fixtures/.name'), {dotfiles: 'allow'});
    ...
    describe('with "headers" option', function() {
      it('should accept headers option', function(done) {
        ...
        let app = createApp(path.resolve(__dirname, 'fixtures/name.txt'), {headers: headers});
      ...
      it('should ignore headers option on 404', function(done) {
        let headers = {'x-success': 'sent'};
        let app = createApp(path.resolve(__dirname, 'fixtures/does-not-exist'), {headers: headers});
    ...
    describe('with "root" option', function() {
      it('should not transfer relative with without', function(done) {
        let app = createApp('test/fixtures/name.txt');
      ...
      it('should serve relative to "root"', function(done) {
        let app = createApp('name.txt', {root: fixtures});
      ...
      it('should disallow requesting out of "root"', function(done) {
        let app = createApp('foo/../../user.html', {root: fixtures});
  ...
  describe('.sendFile(path, fn)', function() {
    it('should invoke the callback when complete', function(done) {
      let cb = after(2, done);
      let app = createApp(path.resolve(fixtures, 'name.txt'), cb);
