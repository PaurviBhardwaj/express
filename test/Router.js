 ...
 res.end(new Error('wrong handler')); 
  ...
  describe('FQDN', function() {
    it('should not obscure FQDNs', function(done) {
      let request = {hit: 0, url: 'http://example.com/foo', method: 'GET'};
      let router = new Router();
    ...
    it('should ignore FQDN in search', function(done) {
      let request = {hit: 0, url: '/proxy?url=http://example.com/blog/post/1', method: 'GET'};
      let router = new Router();
    ...
    it('should ignore FQDN in path', function(done) {
      let request = {hit: 0, url: '/proxy/http://example.com/blog/post/1', method: 'GET'};
      let router = new Router();
    ...
    it('should adjust FQDN req.url', function(done) {
      let request = {hit: 0, url: 'http://example.com/blog/post/1', method: 'GET'};
      let router = new Router();
 ...
 count++; 
  ...
  describe('.param', function() {
    ...
    it('should only call once per request', function(done) {
      let count = 0;
      let req = {url: '/foo/bob/bar', method: 'get'};
      let router = new Router();
      let sub = new Router();
  ...
  describe('parallel requests', function() {
    it('should not mix requests', function(done) {
      let req1 = {url: '/foo/50/bar', method: 'get'};
      let req2 = {url: '/foo/10/bar', method: 'get'};
      let router = new Router();
      let sub = new Router();
